# Generic IAM role for all Dce Lambdas
resource "aws_iam_role" "dce_lambda_execution" {
  name = "dce-lambda-execution-${var.namespace}"
...
resource "aws_iam_role_policy_attachment" "lambda_dynamodb" {
  role       = aws_iam_role.dce_lambda_execution.name
