...
func (_m *SQSAPI) ListDeadLetterSourceQueuesPages(input *sqs.ListDeadLetterSourceQueuesInput, fn func(*sqs.ListDeadLetterSourceQueuesOutput, bool) bool) error {
	panic("SQSAPI::ListDeadLetterSourceQueuesPages - Not implemented")
}

func (_m *SQSAPI) ListDeadLetterSourceQueuesPagesWithContext(ctx aws.Context, input *sqs.ListDeadLetterSourceQueuesInput, fn func(*sqs.ListDeadLetterSourceQueuesOutput, bool) bool, opts ...request.Option) error {
	panic("SQSAPI::ListDeadLetterSourceQueuesPagesWithContext - Not implemented")
}

func (_m *SQSAPI) ListQueuesPages(input *sqs.ListQueuesInput, fn func(*sqs.ListQueuesOutput, bool) bool) error {
	panic("SQSAPI::ListQueuesPages - Not implemented")
}

func (_m *SQSAPI) ListQueuesPagesWithContext(ctx aws.Context, input *sqs.ListQueuesInput, fn func(*sqs.ListQueuesOutput, bool) bool, opts ...request.Option) error {
	panic("SQSAPI::ListQueuesPagesWithContext - Not implemented")
}
