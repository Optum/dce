...
// GetPrincipal provides a mock function with given fields: id, date
func (_m *Servicer) GetPrincipal(id string, date time.Time) (*usage.Principal, error) {
...
func (_m *Servicer) ListPrincipal(query *usage.Principal) (*usage.Principals, error) {
	ret := _m.Called(query)
