...
// AccountReaderUpdater is an autogenerated mock type for the AccountReaderUpdater type
type AccountReaderUpdater struct {
	mock.Mock
}

// GetAccountByID provides a mock function with given fields: accountID, _a1
func (_m *AccountReaderUpdater) GetAccountByID(accountID string, _a1 *model.Account) error {
...
func (_m *AccountReaderUpdater) GetAccounts() (*model.Accounts, error) {
	ret := _m.Called()
...
func (_m *AccountReaderUpdater) GetAccountsByPrincipalID(principalID string) (*model.Accounts, error) {
...
func (_m *AccountReaderUpdater) GetAccountsByStatus(status string) (*model.Accounts, error) {
...
func (_m *AccountReaderUpdater) Update(input *model.Account, lastModifiedOn *int64) error {
