...
// GetAccountByID provides a mock function with given fields: ctx, req
func (_m *Controller) GetAccountByID(ctx context.Context, req *events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	ret := _m.Called(ctx, req)
