...
func (_m *ConfigurationBuilder) WithEnv(key string, envVar string, defaultValue interface{}) *config.DefaultConfigurationBuilder {
	ret := _m.Called(key, envVar, defaultValue)

	var r0 *config.DefaultConfigurationBuilder
	if rf, ok := ret.Get(0).(func(string, string, interface{}) *config.DefaultConfigurationBuilder); ok {
...
func (_m *ConfigurationBuilder) WithParameterStoreEnv(key string, envVar string, defaultValue string) *config.DefaultConfigurationBuilder {
	ret := _m.Called(key, envVar, defaultValue)

	var r0 *config.DefaultConfigurationBuilder
	if rf, ok := ret.Get(0).(func(string, string, string) *config.DefaultConfigurationBuilder); ok {
		r0 = rf(key, envVar, defaultValue)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*config.DefaultConfigurationBuilder)
...
func (_m *ConfigurationBuilder) WithService(svc interface{}) *config.DefaultConfigurationBuilder {
	ret := _m.Called(svc)

	var r0 *config.DefaultConfigurationBuilder
	if rf, ok := ret.Get(0).(func(interface{}) *config.DefaultConfigurationBuilder); ok {
		r0 = rf(svc)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*config.DefaultConfigurationBuilder)
...
func (_m *ConfigurationBuilder) WithVal(key string, val interface{}) *config.DefaultConfigurationBuilder {
	ret := _m.Called(key, val)

	var r0 *config.DefaultConfigurationBuilder
	if rf, ok := ret.Get(0).(func(string, interface{}) *config.DefaultConfigurationBuilder); ok {
		r0 = rf(key, val)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*config.DefaultConfigurationBuilder)
