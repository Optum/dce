...
type mockConstructorTestingTNewServiceBuilder interface {
	mock.TestingT
	Cleanup(func())
}

// NewServiceBuilder creates a new instance of ServiceBuilder. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewServiceBuilder(t mockConstructorTestingTNewServiceBuilder) *ServiceBuilder {
	mock := &ServiceBuilder{}
	mock.Mock.Test(t)
