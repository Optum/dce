...
type Account struct {
	...
	Status              *AccountStatus          `json:"accountStatus,omitempty" dynamodbav:"AccountStatus"`             // Status of the AWS Account
	LastModifiedOn      *int64                  `json:"lastModifiedOn,omitempty" dynamodbav:"LastModifiedOn"`           // Last Modified Epoch Timestamp
	CreatedOn           *int64                  `json:"createdOn,omitempty"  dynamodbav:"CreatedOn"`                    // Account CreatedOn
	...
	PrincipalRoleArn    *string                 `json:"principalRoleArn,omitempty"  dynamodbav:"PrincipalRoleArn"`      // Assumed by principal users
	PrincipalPolicyHash *string                 `json:"principalPolicyHash,omitempty" dynamodbav:"PrincipalPolicyHash"` // The the hash of the policy version deployed
	Metadata            *map[string]interface{} `json:"metadata,omitempty"  dynamodbav:"Metadata"`                      // Any org specific metadata pertaining to the account
}
