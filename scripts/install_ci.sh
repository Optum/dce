...
safeGoInstall github.com/jstemmer/go-junit-report

# gcov is used to generate coverage information in a report that can be read
# by CI tools
safeGoInstall github.com/axw/gocov/gocov
safeGoInstall github.com/AlekSi/gocov-xml
safeGoInstall github.com/matm/gocov-html

# golangci-lint is a lint aggregator used in the lint.sh script to lint the
# go and terraform code.
safeGoInstall github.com/golangci/golangci-lint/cmd/golangci-lint

# gosec is used for checking the code for security problems
safeGoInstall github.com/securego/gosec/cmd/gosec
