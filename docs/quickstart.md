...
The `dce` [command line interface](dce/dce/) (CLI) 
is the easiest way to deploy DCE into your master account. The CLI
uses the REST API on your behalf, making the calls much easier.
