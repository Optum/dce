...
// Its sole purpose is to copy existing records from DcsAccountAssignmentProd
// to DcsLeasetProd table.
//
...
// "export SOURCE_DB=DcsAccountAssignmentProd"  - Name of the Assignment table for Accounts
...
// DcsAccountAssignment record
type DcsAccountAssignment struct {
...
func migrationV10(input *migrationV10Input) error {
	...
	assignments := []DcsAccountAssignment{}
